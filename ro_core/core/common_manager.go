...
// CommonManager controls requests made to the miscellaneous data path agents
type CommonManager struct {
	commonAgent      map[string]*CommonAgent
	clusterDataProxy *model.Proxy
}

func newCommonManager(cdProxy *model.Proxy) *CommonManager {
	var mgr CommonManager
	mgr.commonAgent = make(map[string]*CommonAgent)
	mgr.clusterDataProxy = cdProxy
	return &mgr
}

// GetDeviceType returns the device type associated to the provided id
func (cMgr *CommonManager) GetVoltha(ctx context.Context) (*voltha.Voltha, error) {
	log.Debug("GetVoltha")

	var agent *CommonAgent
	var exists bool

	if agent, exists = cMgr.commonAgent[Voltha.String()]; !exists {
		agent = newCommonAgent("", cMgr.clusterDataProxy)
		cMgr.commonAgent[Voltha.String()] = agent
	}
...
func (cMgr *CommonManager) ListCoreInstances(ctx context.Context) (*voltha.CoreInstances, error) {
...
func (cMgr *CommonManager) GetCoreInstance(ctx context.Context, id string) (*voltha.CoreInstance, error) {
...
func (cMgr *CommonManager) ListAdapters(ctx context.Context) (*voltha.Adapters, error) {
	log.Debug("ListAdapters")

	var agent *CommonAgent
	var exists bool

	if agent, exists = cMgr.commonAgent[Adapters.String()]; !exists {
		agent = newCommonAgent("adapters", cMgr.clusterDataProxy)
		cMgr.commonAgent[Adapters.String()] = agent
	}
...
func (cMgr *CommonManager) ListDeviceTypes(ctx context.Context) (*voltha.DeviceTypes, error) {
	log.Debug("ListDeviceTypes")

	var agent *CommonAgent
	var exists bool

	if agent, exists = cMgr.commonAgent[DeviceTypes.String()]; !exists {
		agent = newCommonAgent("device_types", cMgr.clusterDataProxy)
		cMgr.commonAgent[DeviceTypes.String()] = agent
	}
...
// GetDeviceType returns the device type associated to the provided id
func (cMgr *CommonManager) GetDeviceType(ctx context.Context, id string) (*voltha.DeviceType, error) {
...
func (cMgr *CommonManager) ListDeviceGroups(ctx context.Context) (*voltha.DeviceGroups, error) {
	log.Debug("ListDeviceGroups")

	var agent *CommonAgent
	var exists bool

	if agent, exists = cMgr.commonAgent[DeviceGroups.String()]; !exists {
		agent = newCommonAgent("device_groups", cMgr.clusterDataProxy)
		cMgr.commonAgent[DeviceGroups.String()] = agent
	}
...
func (cMgr *CommonManager) GetDeviceGroup(ctx context.Context, id string) (*voltha.DeviceGroup, error) {
...
func (cMgr *CommonManager) ListAlarmFilters(ctx context.Context) (*voltha.AlarmFilters, error) {
	log.Debug("ListAlarmFilters")

	var agent *CommonAgent
	var exists bool

	if agent, exists = cMgr.commonAgent[AlarmFilters.String()]; !exists {
		agent = newCommonAgent("alarm_filters", cMgr.clusterDataProxy)
		cMgr.commonAgent[AlarmFilters.String()] = agent
	}
...
func (cMgr *CommonManager) GetAlarmFilter(ctx context.Context, id string) (*voltha.AlarmFilter, error) {
