...
func init() {
	...
	TestProxy_Root_LogicalDevice, _ = TestProxy_Root.CreateProxy(context.Background(), "/", false)
	TestProxy_Root_Device, _ = TestProxy_Root.CreateProxy(context.Background(), "/", false)
	TestProxy_Root_Adapter, _ = TestProxy_Root.CreateProxy(context.Background(), "/", false)
...
func TestProxy_1_1_1_Add_NewDevice(t *testing.T) {
	...
	devicesProxy, _ := TestProxy_Root.node.CreateProxy(context.Background(), "/devices", false)
	...
	if added, _ := TestProxy_Root_Device.Add(context.Background(), "/devices", TestProxy_Device, ""); added == nil {
...
func TestProxy_1_1_2_Add_ExistingDevice(t *testing.T) {
	...
	added, _ := TestProxy_Root_Device.Add(context.Background(), "/devices", TestProxy_Device, "")
...
func TestProxy_1_1_3_Add_NewAdapter(t *testing.T) {
	...
	// Add the adapter
	if added, _ := TestProxy_Root_Adapter.Add(context.Background(), "/adapters", TestProxy_Adapter, ""); added == nil {
...
func TestProxy_1_3_1_Update_Device(t *testing.T) {
	...
	if retrieved, _ := TestProxy_Root_Device.Get(context.Background(), "/devices/"+TestProxy_TargetDeviceId, 1, false, ""); retrieved == nil {
		...
		if afterUpdate, _ := TestProxy_Root_Device.Update(context.Background(), "/devices/"+TestProxy_TargetDeviceId, retrieved, false, ""); afterUpdate == nil {
...
func TestProxy_1_3_2_Update_DeviceFlows(t *testing.T) {
	...
	devFlowsProxy, _ := TestProxy_Root.node.CreateProxy(context.Background(), "/devices/"+TestProxy_DeviceId+"/flows", false)
	...
	if updated, _ := devFlowsProxy.Update(context.Background(), "/", flows.(*openflow_13.Flows), false, ""); updated == nil {
...
func TestProxy_1_3_3_Update_Adapter(t *testing.T) {
	...
	adaptersProxy, _ := TestProxy_Root.node.CreateProxy(context.Background(), "/adapters", false)
	...
	if retrieved, _ := TestProxy_Root_Adapter.Get(context.Background(), "/adapters/"+TestProxy_AdapterId, 1, false, ""); retrieved == nil {
		...
		if afterUpdate, _ := adaptersProxy.Update(context.Background(), "/"+TestProxy_AdapterId, retrieved, false, ""); afterUpdate == nil {
...
func TestProxy_1_4_1_Remove_Device(t *testing.T) {
	...
	if removed, _ := TestProxy_Root_Device.Remove(context.Background(), "/devices/"+TestProxy_DeviceId, ""); removed == nil {
...
func TestProxy_2_1_1_Add_NewLogicalDevice(t *testing.T) {
	...
	if added, _ := TestProxy_Root_LogicalDevice.Add(context.Background(), "/logical_devices", TestProxy_LogicalDevice, ""); added == nil {
...
func TestProxy_2_1_2_Add_ExistingLogicalDevice(t *testing.T) {
	...
	added, _ := TestProxy_Root_LogicalDevice.Add(context.Background(), "/logical_devices", TestProxy_LogicalDevice, "")
...
func TestProxy_2_3_1_Update_LogicalDevice(t *testing.T) {
	...
	if retrieved, _ := TestProxy_Root_LogicalDevice.Get(context.Background(), "/logical_devices/"+TestProxy_TargetLogicalDeviceId, 1, false, ""); retrieved == nil {
		...
		if afterUpdate, _ := TestProxy_Root_LogicalDevice.Update(context.Background(), "/logical_devices/"+TestProxy_TargetLogicalDeviceId, retrieved, false,
			""); afterUpdate == nil {
...
func TestProxy_2_3_2_Update_LogicalDeviceFlows(t *testing.T) {
	// Get a device proxy and update a specific port
	ldFlowsProxy, _ := TestProxy_Root.node.CreateProxy(context.Background(), "/logical_devices/"+TestProxy_LogicalDeviceId+"/flows", false)
	...
	if updated, _ := ldFlowsProxy.Update(context.Background(), "/", flows.(*openflow_13.Flows), false, ""); updated == nil {
...
func TestProxy_2_4_1_Remove_Device(t *testing.T) {
	...
	if removed, _ := TestProxy_Root_LogicalDevice.Remove(context.Background(), "/logical_devices/"+TestProxy_LogicalDeviceId, ""); removed == nil {
