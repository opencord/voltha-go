...
func TestProxy_1_1_1_Add_NewDevice(t *testing.T) {
	...
	devicesProxy, err := TestProxyRoot.node.CreateProxy(context.Background(), "/devices", false)
	if err != nil {
...
func TestProxy_1_3_2_Update_DeviceFlows(t *testing.T) {
	...
	devFlowsProxy, err := TestProxyRoot.node.CreateProxy(context.Background(), "/devices/"+TestProxyDeviceID+"/flows", false)
	if err != nil {
...
func TestProxy_1_3_3_Update_Adapter(t *testing.T) {
	...
	adaptersProxy, err := TestProxyRoot.node.CreateProxy(context.Background(), "/adapters", false)
	if err != nil {
...
func TestProxy_2_3_2_Update_LogicalDeviceFlows(t *testing.T) {
	// Get a device proxy and update a specific port
	ldFlowsProxy, err := TestProxyRoot.node.CreateProxy(context.Background(), "/logical_devices/"+TestProxyLogicalDeviceID+"/flows", false)
	if err != nil {
