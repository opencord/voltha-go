...
import (
	...
	mocks "github.com/opencord/voltha-lib-go/v2/pkg/mocks"
...
var etcdServer *mocks.EtcdServer
...
func initTestRoot() (*db.Backend, error) {
	...
	if err == nil {
		...
		etcdServer = mocks.StartEtcdServer(mocks.MKConfig("voltha.db.model.TestDbModelRoot", clientPort, peerPort, "voltha.lib.db.model.TestDbModelRoot_etcd", "error"))
		if etcdServer == nil {
