...
func (PONRMgr *PONResourceManager) UpdateRanges(StartIDx string, StartID uint32, EndIDx string, EndID uint32,
    ...
    */
    fmt.Printf("\n\n update ranges for %s, %d", StartIDx, StartID)
...
func (PONRMgr *PONResourceManager) InitDeviceResourcePool() bool {
...
func (PONRMgr *PONResourceManager) GetResource(Path string) (map[string]interface{}, error) {
    ...
    */
    ...
    if (err != nil) || (Resource == nil) {
        log.Errorf("Failed to get resource from path %s", Path)
        return nil, err
    }
...
func (PONRMgr *PONResourceManager) GetFlowIDInfo(IntfONUID string, FlowID uint32) interface{} {
    /*
