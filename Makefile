...
RWCORE_NAME              ?= voltha-rw-core
ROCORE_NAME              ?= voltha-ro-core
AFROUTER_NAME            ?= afrouter
AFROUTERTEST_NAME        ?= afroutertest
AFROUTERD_NAME           ?= afrouterd
SIMULATEDOLT_NAME        ?= voltha-adapter-simulated-olt
SIMULATEDONU_NAME        ?= voltha-adapter-simulated-onu
...
DOCKER_BUILD_ARGS        ?=
DOCKER_TAG               ?= ${VERSION}
RWCORE_IMAGENAME         := ${DOCKER_REGISTRY}${DOCKER_REPOSITORY}${RWCORE_NAME}:${DOCKER_TAG}
ROCORE_IMAGENAME         := ${DOCKER_REGISTRY}${DOCKER_REPOSITORY}${ROCORE_NAME}:${DOCKER_TAG}
AFROUTER_IMAGENAME       := ${DOCKER_REGISTRY}${DOCKER_REPOSITORY}${AFROUTER_NAME}:${DOCKER_TAG}
AFROUTERTEST_IMAGENAME   := ${DOCKER_REGISTRY}${DOCKER_REPOSITORY}${AFROUTERTEST_NAME}:${DOCKER_TAG}
AFROUTERD_IMAGENAME      := ${DOCKER_REGISTRY}${DOCKER_REPOSITORY}${AFROUTERD_NAME}:${DOCKER_TAG}
SIMULATEDOLT_IMAGENAME   := ${DOCKER_REGISTRY}${DOCKER_REPOSITORY}${SIMULATEDOLT_NAME}:${DOCKER_TAG}
SIMULATEDONU_IMAGENAME   := ${DOCKER_REGISTRY}${DOCKER_REPOSITORY}${SIMULATEDONU_NAME}:${DOCKER_TAG}
...
afrouter: local-protos
    ...
    --build-arg org_label_schema_name="${AFROUTER_NAME}" \
...
afrouterTest: local-protos
    ...
    --build-arg org_label_schema_name="${AFROUTERTEST_NAME}" \
    --build-arg org_label_schema_version="${VERSION}" \
    --build-arg org_label_schema_vcs_url="${DOCKER_LABEL_VCS_URL}" \
    --build-arg org_label_schema_vcs_ref="${DOCKER_LABEL_VCS_REF}" \
    --build-arg org_label_schema_build_date="${DOCKER_LABEL_BUILD_DATE}" \
...
afrouterd: local-protos
    ...
    --build-arg org_label_schema_name="${AFROUTERD_NAME}" \
    --build-arg org_label_schema_version="${VERSION}" \
    --build-arg org_label_schema_vcs_url="${DOCKER_LABEL_VCS_URL}" \
    --build-arg org_label_schema_vcs_ref="${DOCKER_LABEL_VCS_REF}" \
    --build-arg org_label_schema_build_date="${DOCKER_LABEL_BUILD_DATE}" \
...
rw_core: local-protos
	docker build $(DOCKER_BUILD_ARGS) \
    -t ${RWCORE_IMAGENAME} \
    --build-arg org_label_schema_name="${RWCORE_NAME}" \
    --build-arg org_label_schema_version="${VERSION}" \
    --build-arg org_label_schema_vcs_url="${DOCKER_LABEL_VCS_URL}" \
    --build-arg org_label_schema_vcs_ref="${DOCKER_LABEL_VCS_REF}" \
    --build-arg org_label_schema_build_date="${DOCKER_LABEL_BUILD_DATE}" \
...
ro_core: local-protos
	docker build $(DOCKER_BUILD_ARGS) \
    -t ${ROCORE_IMAGENAME} \
    --build-arg org_label_schema_name="${ROCORE_NAME}" \
    --build-arg org_label_schema_version="${VERSION}" \
    --build-arg org_label_schema_vcs_url="${DOCKER_LABEL_VCS_URL}" \
    --build-arg org_label_schema_vcs_ref="${DOCKER_LABEL_VCS_REF}" \
    --build-arg org_label_schema_build_date="${DOCKER_LABEL_BUILD_DATE}" \
...
simulated_olt: local-protos
    ...
    --build-arg org_label_schema_name="${SIMULATEDOLT_NAME}" \
    --build-arg org_label_schema_version="${VERSION}" \
    --build-arg org_label_schema_vcs_url="${DOCKER_LABEL_VCS_URL}" \
    --build-arg org_label_schema_vcs_ref="${DOCKER_LABEL_VCS_REF}" \
    --build-arg org_label_schema_build_date="${DOCKER_LABEL_BUILD_DATE}" \
