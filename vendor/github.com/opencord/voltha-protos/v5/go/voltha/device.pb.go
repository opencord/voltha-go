...
type OnuSerialNumberOfOLTPon struct {
...
func (m *OnuSerialNumberOfOLTPon) Reset()         { *m = OnuSerialNumberOfOLTPon{} }
func (m *OnuSerialNumberOfOLTPon) String() string { return proto.CompactTextString(m) }
func (*OnuSerialNumberOfOLTPon) ProtoMessage()    {}
func (*OnuSerialNumberOfOLTPon) Descriptor() ([]byte, []int) {
	return fileDescriptor_200940f73d155856, []int{22}
}

func (m *OnuSerialNumberOfOLTPon) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_OnuSerialNumberOfOLTPon.Unmarshal(m, b)
}
func (m *OnuSerialNumberOfOLTPon) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_OnuSerialNumberOfOLTPon.Marshal(b, m, deterministic)
}
func (m *OnuSerialNumberOfOLTPon) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OnuSerialNumberOfOLTPon.Merge(m, src)
}
func (m *OnuSerialNumberOfOLTPon) XXX_Size() int {
	return xxx_messageInfo_OnuSerialNumberOfOLTPon.Size(m)
}
func (m *OnuSerialNumberOfOLTPon) XXX_DiscardUnknown() {
	xxx_messageInfo_OnuSerialNumberOfOLTPon.DiscardUnknown(m)
}

var xxx_messageInfo_OnuSerialNumberOfOLTPon proto.InternalMessageInfo

func (m *OnuSerialNumberOfOLTPon) GetOltDeviceId() *common.ID {
	if m != nil {
...
func (m *OnuSerialNumberOfOLTPon) GetPort() *Port {
	if m != nil {
		return m.Port
	}
	return nil
...
func (m *OnuSerialNumberOfOLTPon) GetSerialNumber() string {
	if m != nil {
		return m.SerialNumber
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*OnuSerialNumberOfOLTPon)(nil), "device.OnuSerialNumberOfOLTPon")
}
...
var fileDescriptor_200940f73d155856 = []byte{
	...
	0xb3, 0xe1, 0xde, 0x78, 0x9f, 0x86, 0x68, 0x0b, 0xda, 0x34, 0x48, 0x9c, 0x22, 0xfd, 0x16, 0x23,
	0xae, 0x49, 0x83, 0x24, 0x75, 0xe6, 0x5d, 0x58, 0xe1, 0xb7, 0xb5, 0x20, 0x8c, 0x62, 0xde, 0xc7,
	0x25, 0x17, 0x93, 0x98, 0xca, 0xc5, 0x24, 0x66, 0xe7, 0x73, 0xd8, 0xa0, 0xd1, 0x11, 0x4f, 0x92,
	0xa7, 0x34, 0xf2, 0xb6, 0xc4, 0xff, 0x7b, 0xd2, 0xda, 0x4e, 0xeb, 0x80, 0x37, 0xc5, 0xa0, 0x9f,
	0x6f, 0x1d, 0xf9, 0xc9, 0xf1, 0xf2, 0x90, 0xcd, 0x68, 0x5b, 0x75, 0xd8, 0x16, 0x1d, 0xde, 0x93,
	0x7f, 0x08, 0x9e, 0x7c, 0x67, 0xfb, 0x88, 0x4a, 0xec, 0xb0, 0xc6, 0xc1, 0x47, 0xff, 0x0e, 0x00,
	0x00, 0xff, 0xff, 0x01, 0x22, 0x5e, 0xb9, 0x90, 0x1c, 0x00, 0x00,
}
