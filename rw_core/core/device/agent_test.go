...
func (dat *DATest) startCore(inCompeteMode bool) {
	...
	dat.deviceMgr, dat.logicalDeviceMgr = NewManagers(proxy, adapterMgr, eventMgr, dat.kmp, endpointMgr, cfg.CorePairTopic, dat.coreInstanceID, cfg.DefaultCoreTimeout)
