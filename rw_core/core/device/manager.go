...
func NewDeviceManagers(proxy *model.Proxy, adapterMgr *adapter.Manager, eventMgr *event.Manager, kmp kafka.InterContainerProxy, endpointMgr kafka.EndpointManager, corePairTopic, coreInstanceID string, defaultCoreTimeout time.Duration) (*Manager, *LogicalManager) {
	deviceMgr := &Manager{
