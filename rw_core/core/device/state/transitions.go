...
type DeviceManager interface {
	...
	DeleteParentPorts(ctx context.Context, curr *voltha.Device) error
}
...
func NewTransitionMap(dMgr DeviceManager) *TransitionMap {
	...
	transitionMap.transitions = append(transitionMap.transitions,
		transition{ //DELETE device forcefully
			...
			handlers:      []transitionHandler{dMgr.DeleteAllLogicalPorts, dMgr.DeleteAllLogicalMeters, dMgr.DeleteAllChildDevices, dMgr.DeleteLogicalDevice, dMgr.DeleteParentPorts, dMgr.RunPostDeviceDelete}})
	transitionMap.transitions = append(transitionMap.transitions,
