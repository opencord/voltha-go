...
func NewTransitionMap(dMgr DeviceManager) *TransitionMap {
	...
	transitionMap.transitions = append(transitionMap.transitions,
		transition{
			...
			currentState:  deviceState{Admin: voltha.AdminState_ENABLED, Connection: voltha.ConnectStatus_REACHABLE, Operational: voltha.OperStatus_REBOOTED, Transient: core.DeviceTransientState_OLT_REBOOT_IN_PROGRESS},
