...
func (dMgr *Manager) DisableOnuSerialNumber(ctx context.Context, device *voltha.OnuSerialNumberOfOLTPon) (*empty.Empty, error) {
...
func (dMgr *Manager) EnableOnuSerialNumber(ctx context.Context, device *voltha.OnuSerialNumberOfOLTPon) (*empty.Empty, error) {
	...
	return &empty.Empty{}, oltAgent.enableOnuSerialNumber(ctx, device, agent)
}
