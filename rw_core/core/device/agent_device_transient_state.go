...
func (agent *Agent) getDeviceTransientState() voltha.DeviceTransientState_Types {
...
func (agent *Agent) updateDeviceTransientState(ctx context.Context, transientState voltha.DeviceTransientState_Types) error {
...
func (agent *Agent) isProcessingDeletingTransientState() bool {
	deviceTransientState := agent.getDeviceTransientState()
	if deviceTransientState == voltha.DeviceTransientState_FORCE_DELETING ||
...
func (agent *Agent) isGivenTransitionStateDeleting(deviceTransientState voltha.DeviceTransientState_Types) bool {
	if deviceTransientState == voltha.DeviceTransientState_FORCE_DELETING ||
		deviceTransientState == voltha.DeviceTransientState_DELETING_FROM_ADAPTER ||
		deviceTransientState == voltha.DeviceTransientState_DELETING_POST_ADAPTER_RESPONSE {
		return true
