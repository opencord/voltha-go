...
func (ldMgr *LogicalDeviceManager) SetEventCallbacks(callbacks EventCallbacks) {
...
func (ldMgr *LogicalDeviceManager) PacketOut(ctx context.Context, packet *openflow_13.PacketOut) {
