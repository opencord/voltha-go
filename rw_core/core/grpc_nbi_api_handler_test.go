...
func (nb *NBTest) startCore(inCompeteMode bool) {
	...
	nb.core = newRWCoreUnderTest(nb.coreInstanceId, cfg, client, nb.kClient)
...
func (nb *NBTest) createAndregisterAdapters() {
	...
	nb.core.GetAdapterManager().RegisterAdapter(registrationData, deviceTypes)
