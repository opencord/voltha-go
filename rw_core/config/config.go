...
type RWCoreFlags struct {
	...
	KafkaClusterAddress         string        `default:"127.0.0.1:9094" description:"Kafka - Cluster messaging address"`
	...
	EventTopic                  string        `default:"voltha.events" description:"RW Core Event topic"`
	...
	VolthaStackID               string        `long:"stack_id" default:"voltha" description:"ID for the current voltha stack"`
	BackoffRetryInitialInterval time.Duration `default:"500ms" description:"The initial number of milliseconds an exponential backoff will wait before a retry"`
	BackoffRetryMaxElapsedTime  time.Duration `default:"0s" description:"The maximum number of milliseconds an exponential backoff can elasped"`
	BackoffRetryMaxInterval     time.Duration `default:"1m" description:"The maximum number of milliseconds of an exponential backoff interval"`
}
