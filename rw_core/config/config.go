...
const (
	...
	defaultConnectionRetryInterval   = 2  // in seconds
	defaultLiveProbeInterval         = 60 // in seconds
	defaultNotLiveProbeInterval      = 60 // in seconds
	defaultProbeHost                 = ""
...
func (cf *RWCoreFlags) ParseCommandArguments() {
	...
	flag.IntVar(&(cf.ConnectionRetryInterval), "connection_retry_interval", defaultConnectionRetryInterval, help)

	help = fmt.Sprintf("The number of seconds between liveness probes while in a live state")
	flag.IntVar(&(cf.LiveProbeInterval), "live_probe_interval", defaultLiveProbeInterval, help)

	help = fmt.Sprintf("The number of seconds between liveness probes while in a not live state")
	flag.IntVar(&(cf.NotLiveProbeInterval), "not_live_probe_interval", defaultNotLiveProbeInterval, help)
