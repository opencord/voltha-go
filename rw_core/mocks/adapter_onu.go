...
func (onuA *ONUAdapter) DisableOnuSerialNumber(ctx context.Context, in *voltha.OnuSerialNumberOfOLTPon) (*empty.Empty, error) {
	return &empty.Empty{}, nil
}

func (onuA *ONUAdapter) EnableOnuSerialNumber(ctx context.Context, in *voltha.OnuSerialNumberOfOLTPon) (*empty.Empty, error) {
	return &empty.Empty{}, nil
}
