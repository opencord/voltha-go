...
func (oltA *OLTAdapter) Disable_device(ctx context.Context, device *voltha.Device) error { // nolint
	go func() {
		...
		if err := oltA.coreProxy.PortsStateUpdate(context.TODO(), cloned.Id, voltha.Port_ALL, voltha.OperStatus_UNKNOWN); err != nil {
...
func (oltA *OLTAdapter) Reenable_device(ctx context.Context, device *voltha.Device) error { // nolint
	go func() {
		...
		if err := oltA.coreProxy.PortsStateUpdate(context.TODO(), cloned.Id, voltha.Port_ALL, voltha.OperStatus_ACTIVE); err != nil {
...
func (oltA *OLTAdapter) Reboot_device(ctx context.Context, device *voltha.Device) error { // nolint
	...
	go func() {
		...
		if err := oltA.coreProxy.PortsStateUpdate(context.TODO(), device.Id, voltha.Port_ALL, voltha.OperStatus_UNKNOWN); err != nil {
