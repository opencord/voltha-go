...
import (
	...
	mock_etcd "github.com/opencord/voltha-lib-go/v6/pkg/mocks/etcd"
...
func (nb *NBTest) startGRPCCore(ctx context.Context, t *testing.T) (apiEndpoint string) {
	// Setup the configs
...
func setUpCore(ctx context.Context, t *testing.T, nb *NBTest) (voltha.VolthaServiceClient, string) {
	// Start the Core
	coreAPIEndpoint := nb.startGRPCCore(ctx, t)
	...
	conn, err := grpc.Dial(coreAPIEndpoint, grpc.WithInsecure())
	if err != nil {
