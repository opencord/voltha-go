...
func NewAgent(controllerEndpoint string, datapathId int, deviceId string, rpcStub *GrpcClient, enableTls bool, keyFile string, certFile string, connRetryInterval int) *Agent {
	var agent Agent
