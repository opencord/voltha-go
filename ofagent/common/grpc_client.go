...
func NewGrpcClient(connection_manager ConnectionManager, channel int, grpc_timeout int, core_binding_key string) *GrpcClient {
...
func (e GrpcClient) start() GrpcClient {
	...
	//reactor.callLater(0, e.packet_in_forwarder_loop)
	//reactor.callLater(0, e.change_event_processing_loop)
...
func (e GrpcClient) send_packet_out(device_id int, packet_out string) {
	// need a PacketOut data type
	//packet_out = PacketOut(id=device_id, packet_out=packet_out)
	//e.packet_out_queue.Put(packet_out)
}

func (e GrpcClient) get_port(device_id int, port_id int) {
...
func (e GrpcClient) get_port_list(device_id int) {
	//req = ID(id=device_id)
	//res = yield threads.deferToThread(
...
//@inlineCallbacks
func (e GrpcClient) enable_port(device_id int, port_id int) {
...
//@inlineCallbacks
func (e GrpcClient) disable_port(device_id int, port_id int) {
	//req = LogicalPortId(device_id, port_id)
	//res = yield threads.deferToThread(
...
//@inlineCallbacks
func (e GrpcClient) get_device_info(device_id int) {
	//req = ID(device_id)
...
//@inlineCallbacks
func (e GrpcClient) update_flow_table(device_id int, flow_mod int) {
...
//@inlineCallbacks
func (e GrpcClient) update_group_table(device_id int, group_mod int) {
...
//@inlineCallbacks
func (e GrpcClient) list_flows(device_id int) {
	//    req = ID(id=device_id)
	//    res = yield threads.deferToThread(
...
//@inlineCallbacks
func (e GrpcClient) list_groups(device_id int) {
	//     req = ID(id=device_id)
	//     res = yield threads.deferToThread(
...
//@inlineCallbacks
func (e GrpcClient) list_ports(device_id int) {
	//    req = ID(id=device_id)
	//    res = yield threads.deferToThread(
	//        e.local_stub.ListLogicalDevicePorts, req, timeout=e.grpc_timeout,
	//        metadata=((e.core_group_id_key, e.core_group_id),))
...
//@inlineCallbacks
func (e GrpcClient) subscribe(subscriber int) {
